        ...
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info" >
                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" role="form" action="http://localhost:8888/work/index.php/home/login" method="post" >
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body" >
                            <form id="signupform" class="form-horizontal" role="form" action="http://localhost:8888/work/index.php/home/register" method="post">
                                ...
                                <div class="form-group">
                                    <label for="radio" class="col-md-3 control-label">Role</label>
                                    <div class="col-md-9">
                                        <input type="radio" name="role" value="tech"> Tech
                                    </div>

                                    <label class="radio-inline" class="col-md-3 control-label"></label>
                                    <div class="col-md-4">
